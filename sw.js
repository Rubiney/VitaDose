...
const ASSETS = [
  ...
  '/cartao-resumo.html',
  '/importar-csv.html',
  '/farmacia-parceira.html',
  '/lista-reabastecimento.html',
  '/controle-peso.html',
  '/diario-inr.html',
  '/oximetria.html',
  '/receitas-validade.html',
  '/custo-tratamento.html',
  '/adesao-dispensacao.html',
  '/dashboard-domiciliar.html',
  '/emergencias-domiciliares.html',
  '/retorno-farmaceutico.html',
  '/mapa-posologico.html',
  '/diario-temperatura.html',
  '/reconciliacao-alta.html',
  '/manifest.json',
  '/icons/icon-192.svg',
  '/icons/icon-512.svg',
];
